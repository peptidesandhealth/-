...
const translations = {
    ru: {
        ...
        'faq.q5.answer': 'Совместимость зависит от индивидуальных факторов. На консультации мы уточняем вашу текущую терапию и подбираем корректный формат сопровождения.',
...
// ========================================
// Consultation Steps - Static (no dynamic cards)
// ========================================
