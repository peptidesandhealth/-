...
const translations = {
    ru: {
        ...
        'skills.item1.tags': 'травмы • перегрузки • восстановление тканей • адаптация к нагрузкам',
        'skills.item2.title': 'Опорно-двигательный аппарат',
        'skills.item2.tags': 'суставы • связки • сухожилия • мышечное восстановление',
        'skills.item3.title': 'Кожа и дермальные структуры',
        'skills.item3.tags': 'тонус • плотность • текстура • восстановление',
        'skills.item4.title': 'Сон и стресс-нагрузка',
        'skills.item4.tags': 'стресс • сон • восстановление • адаптация',
        'skills.item5.title': 'Иммунная поддержка',
        'skills.item5.tags': 'иммунный ресурс • восстановление • сезонные риски • поддержка организма',
        'skills.item6.title': 'Метаболический профиль',
        'skills.item6.tags': 'вес • аппетит • энергия • метаболизм',
    ...
    en: {
        ...
        'skills.item1.tags': 'injuries • overloads • tissue recovery • adaptation to stress',
        'skills.item2.title': 'Musculoskeletal System',
        'skills.item2.tags': 'joints • ligaments • tendons • muscle recovery',
        'skills.item3.title': 'Skin & Dermal Structures',
        'skills.item3.tags': 'tone • density • texture • recovery',
        'skills.item4.title': 'Sleep & Stress Load',
        'skills.item4.tags': 'stress • sleep • recovery • adaptation',
        'skills.item5.title': 'Immune Support',
        'skills.item5.tags': 'immune resource • recovery • seasonal risks • body support',
        'skills.item6.title': 'Metabolic Profile',
        'skills.item6.tags': 'weight • appetite • energy • metabolism',
